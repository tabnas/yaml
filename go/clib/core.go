...
//
// libtabnasyaml is the yaml format parser as a C shared library, one of
...
import (
	...
	plug "github.com/tabnas/yaml/go"
)

const (
	templateVersion = "v1"
	libName         = "libtabnasyaml"
	formatName      = "yaml"
	valueOut        = true
)
...
// newParser builds one engine with the yaml grammar installed
...
// parseWith answers whether src is in the yaml language — and,
